...
#Polynomial features
train$columnname <- traincolumnname^2
train$columnname <- traincolumnname^3 # similarly upto degree we want
test$columnname <- testcolumnname^2
test$columnname <- testcolumnname^3 # similarly upto degree we want
