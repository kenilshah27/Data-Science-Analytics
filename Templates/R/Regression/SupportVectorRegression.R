...
#Model
library(e1071)
model <- svm(DependentVariable ~.,data = train,
             type = 'eps-regression',kernel = 'radial') # type to decide whether classification or regression
                                                        # radial for a gaussian kernel ( non linear)
