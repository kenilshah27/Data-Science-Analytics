...
y_pred = knn(train = training$IndependentVariables,
             test = test$IndependentVariable,
             cl = training$DependentVariable,
             k = 5,
             prob = TRUE)  # traingin the model on train and testing

#You can change the arguments to get better results
