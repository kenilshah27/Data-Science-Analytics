# -*- coding: utf-8 -*-
"""
Created on Sat Jan 26 20:48:51 2019
...
#Model
from sklearn.naive_bayes import GaussianNB,  # Other Naive Bayes algorithm can also be used like BernoulliNB etc
model = GaussianNB() #minkowski as metric and p = 2 represents Euclidean 
